...
/**
 * The Pipeline used by the Sumologic. Processes KinesisMessageModel records in
 * JSON String format. Uses:
 * <ul>
 ...
 * </ul>
 */
public class SumologicMessageModelPipeline implements IKinesisConnectorPipeline<SimpleKinesisMessageModel, String> {
  ...
  @Override
  public ITransformer<SimpleKinesisMessageModel, String> getTransformer(KinesisConnectorConfiguration configuration) {
    ...
    try {
      ...
      ITransformer<SimpleKinesisMessageModel, String> ITransformerObject = (ITransformer<SimpleKinesisMessageModel, String>) ModelClass
          .newInstance();
