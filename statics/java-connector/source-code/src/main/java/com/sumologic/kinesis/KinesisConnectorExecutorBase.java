...
public abstract class KinesisConnectorExecutorBase<T, U> implements Runnable {
    ...
    /**
     * Initialize the Amazon Kinesis Client Library configuration and worker with
     * metrics factory
     * 
     * @param kinesisConnectorConfiguration Amazon Kinesis connector configuration
     * @param metricFactory                 would be used to emit metrics in Amazon
    ...
    /**
     * This method returns a {@link KinesisConnectorRecordProcessorFactory} that
     * contains the appropriate {@link IKinesisConnectorPipeline} for the Amazon
     * Kinesis Enabled Application
     * 
     * @return a {@link KinesisConnectorRecordProcessorFactory} that contains the
     *         appropriate {@link IKinesisConnectorPipeline} for the Amazon Kinesis
     *         Enabled Application
     */
